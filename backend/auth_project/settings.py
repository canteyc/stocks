...
SECRET_KEY = 'django-insecure-&n!+p45ifl7@bvk&s-xo8i(&^y2tk1q9j#w+pdn=ww#dgj$e)b'
...
# When CORS_ALLOW_CREDENTIALS is True, you cannot use CORS_ALLOW_ALL_ORIGINS = True.
# The browser requires a specific origin in the Access-Control-Allow-Origin header.
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8080",
    "http://127.0.0.1:8080",
    "null", # Important for opening local HTML files directly (file://)
]
